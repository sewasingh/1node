...
// Copyright (c) 2016-2017 The 1Node developers
...
#define SPORK_14_MN_WINNER_MINIMUM_AGE_DEFAULT 8000               // Age in seconds. This should be > MASTERNODE_REMOVAL_SECONDS to avoid

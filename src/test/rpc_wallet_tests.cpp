...
BOOST_AUTO_TEST_CASE(rpc_wallet)
{
    ...
    BOOST_CHECK_THROW(CallRPC("setaccount YLWC7eW14MQXpsCnsEJdsxEKZKeKBQ7Usu nullaccount"), runtime_error);
    BOOST_CHECK_THROW(CallRPC("setaccount"), runtime_error);
    /* YLWC7eW14MQXpsCnsEJdsxEKZKeKBQ7Us (33 chars) is an illegal address (should be 34 chars) */
    BOOST_CHECK_THROW(CallRPC("setaccount YLWC7eW14MQXpsCnsEJdsxEKZKeKBQ7Us nullaccount"), runtime_error);
    ...
    BOOST_CHECK_THROW(CallRPC("signmessage YLWC7eW14MQXpsCnsEJdsxEKZKeKBQ7Us0 mymessage"), runtime_error);

    /* missing arguments */
    BOOST_CHECK_THROW(CallRPC("verifymessage " + demoAddress.ToString()), runtime_error);
    BOOST_CHECK_THROW(CallRPC("verifymessage " + demoAddress.ToString() + " " + retValue.get_str()), runtime_error);
    /* Illegal address */
    BOOST_CHECK_THROW(CallRPC("verifymessage YLWC7eW14MQXpsCnsEJdsxEKZKeKBQ7Us " + retValue.get_str() + " mymessage"), runtime_error);
    /* wrong address */
    BOOST_CHECK(CallRPC("verifymessage YLWC7eW14MQXpsCnsEJdsxEKZKeKBQ7Usu " + retValue.get_str() + " mymessage").get_bool() == false);

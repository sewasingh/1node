...
static std::string ValueToString(CAmount nValue, bool AllowNegative = false)
{
    ...
    QString Str = BitcoinUnits::formatWithUnit(BitcoinUnits::XON, nValue);
...
{
    std::string genesisblockhash = "00000f69bd964ff1e36b39aa527110b43d14fd325512ec033a35b91362d2a2d8";
...
void BlockExplorer::showEvent(QShowEvent*)
{
    if (m_NeverShown) {
        ...
        if (!GetBoolArg("-txindex", false)) {
            QString Warning = tr("Not all transactions will be shown. To view all transactions you need to set txindex=1 in the configuration file (1node.conf).");
            QMessageBox::warning(this, "1Node Core Blockchain Explorer", Warning, QMessageBox::Ok);
        }
    }
}
...
{
    QString CSS = "body {font-size:12px; color:#444;}\n a, span { font-family: monospace; }\n span.addr {color:#13BE5D; font-weight: bold;}\n table tr td {padding: 3px; border: none; background-color: #EEF6E1;}\n td.d0 {font-weight: bold;background-color:#CDE4A6 ;}\n h2, h3 { white-space:nowrap; color:#335333;}\n a { text-decoration:none; }\n a.nav {color:green;}\n";

                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("1Node Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a 1Node address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and 1node: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About 1Node Core"), this);
    aboutAction->setStatusTip(tr("Show information about 1Node Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for 1Node"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your 1Node addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified 1Node addresses"));
    ...
    openAction->setStatusTip(tr("Open a 1Node: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the 1Node Core help message to get a list with possible 1Node command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("1Node Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to 1Node network", "", count));
}
...
{
    QString strTitle = tr("1Node Core"); // default title
...
void UnitDisplayStatusBarControl::updateDisplayUnit(int newUnits)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        setPixmap(QIcon(":/icons/unit_" + BitcoinUnits::id(newUnits)).pixmap(44, STATUSBAR_ICONSIZE));
    } else {
        setPixmap(QIcon(":/icons/unit_t" + BitcoinUnits::id(newUnits)).pixmap(44, STATUSBAR_ICONSIZE));
    }
}

...
/** Utility functions used by the 1Node Qt UI.
 */
namespace GUIUtil
{
...
// Render 1Node addresses in monospace font
...
// Parse "1node:" URI into recipient object, return true on successful parsing

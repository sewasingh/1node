...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("1Node Core 1node-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  1node-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded 1node transaction") + "\n" +
                               "  1node-tx [options] -create [commands]   " + _("Create hex-encoded 1node transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded 1node transaction

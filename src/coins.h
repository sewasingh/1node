...
/** 
    ...
    ****Note - for 1Node we added fCoinStake to the 2nd bit. Keep in mind when reading the following and adjust as needed.
...
public:
    ...
    /** 
     * Amount of 1node coming in to a transaction

...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* 1Node features */
        {"1node", "masternode", &masternode, true, true, false},
        {"1node", "listmasternodes", &listmasternodes, true, true, false},
        {"1node", "getmasternodecount", &getmasternodecount, true, true, false},
        {"1node", "masternodeconnect", &masternodeconnect, true, true, false},
        {"1node", "masternodecurrent", &masternodecurrent, true, true, false},
        {"1node", "masternodedebug", &masternodedebug, true, true, false},
        {"1node", "startmasternode", &startmasternode, true, true, false},
        {"1node", "createmasternodekey", &createmasternodekey, true, true, false},
        {"1node", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"1node", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"1node", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"1node", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"1node", "getmasternodescores", &getmasternodescores, true, true, false},
        {"1node", "mnbudget", &mnbudget, true, true, false},
        {"1node", "preparebudget", &preparebudget, true, true, false},
        {"1node", "submitbudget", &submitbudget, true, true, false},
        {"1node", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"1node", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"1node", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"1node", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"1node", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"1node", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"1node", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"1node", "checkbudgets", &checkbudgets, true, true, false},
        {"1node", "mnsync", &mnsync, true, true, false},
        {"1node", "spork", &spork, true, true, false},
        {"1node", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"1node", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use 1noded, or the -server option to 1node-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> 1node-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:63983/\n";
}

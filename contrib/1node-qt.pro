...
RESOURCES += src/qt/1node.qrc src/qt/1node_locale.qrc

TRANSLATIONS += src/qt/locale/1node_bg.ts \
                src/qt/locale/1node_de.ts \
                src/qt/locale/1node_en.ts \
                src/qt/locale/1node_es.ts \
                src/qt/locale/1node_fi.ts \
                src/qt/locale/1node_fr.ts \
                src/qt/locale/1node_it.ts \
                src/qt/locale/1node_ja.ts \
                src/qt/locale/1node_pl.ts \
                src/qt/locale/1node_pt.ts \
                src/qt/locale/1node_ru.ts \
                src/qt/locale/1node_sk.ts \
                src/qt/locale/1node_sv.ts \
                src/qt/locale/1node_vi.ts \
                src/qt/locale/1node_zh_CN.ts \
                src/qt/locale/1node_zh_TW.ts

...
In order to support loading of multiple wallets in 1node-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is 1node.cpp.
...
Changes to 1node.cpp
----------------------
1node.cpp is the entry point into 1node-qt, and as such, will require some minor modifications to provide hooks for
